...
class PodWorldEnv(gym.Env, utils.EzPickle):
    ...
    def __init__(self,
        ...
        self.action_space = spaces.Box(0, 1, shape=(2,2), dtype=np.float32)
        self.action_space_size = self.action_space.shape[0] * self.action_space.shape[1]
        ...
        self._action_pts = list(self._get_pts_on_circle(
            self.action_space_size, self.action_strength, act_start_angle, act_end_angle))
