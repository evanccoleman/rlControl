...
There are several different scripts in this repo, each divided into their own folder. Navigate to the folder with the desired script and run `python {script} -h` to view the instructions for that script. Refer to the section "Project Layout" to view what scripts are available.
